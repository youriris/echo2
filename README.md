...
Just in case you get confused, mutation of AST or genration of a new Scala Module happens during compilation. In your IDE, **Echo.echo("How are you")** will compile and will not with a wrong signature even though they defined as abstract in your **Echo** trait. You're calling the **echo()** method in the companion object of **Echo**, generated by the Scala Macro during compile time.
